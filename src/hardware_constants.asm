...
; MBC2
MBC2RamEnable EQU $0000
MBC2RomBank   EQU $2000
MBC2Ram       EQU $a000
...
INPUT_LEFT EQU 5
INPUT_UP EQU 6
INPUT_DOWN EQU 7 ;these have to be defined here because of CB opcodes
INPUT_RESET EQU (1<<INPUT_A) | (1<<INPUT_B) | (1<<INPUT_SELECT) | (1<<INPUT_START)

BLANK_POINTER EQU $0000

;base data bitflags
BASE_MISSILE EQU 0
BASE_FUEL EQU 1
BASE_SHIELD EQU 2
BASE_DESTROYED EQU 7 
...
rSTAT_MODE_NOT_BLANKING EQU 2 ;bitflag, this is on when we're not in a blanking period (we wait on this a lot)
